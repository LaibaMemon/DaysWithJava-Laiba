...
class MainClassPerson
{
	...
	{
		Person p1=new Person("Laiba Memon","A-908, khai Road, Phase-I, Hyderabad");

		System.out.println(p1.toString());

		Student s1=new Student("Aemon Jabbar","A-908, khai Road, Phase-I, Hyderabad","Software Engineering",2018,3200);

		System.out.println(s1.toString());

		Staff st=new Staff("adeel Ahmed","A-908, khai Road, Phase-I, Hyderabad","The Elonera School",15000);
